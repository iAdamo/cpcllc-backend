...
export class CreateAdminDto {
  ...
  @ApiProperty({ description: 'List of monitored client IDs', type: [String], required: false })
  @IsOptional()
  @IsArray()
  @IsMongoId({ each: true })
  monitoredClients?: string[];

  @ApiProperty({ description: 'List of monitored company IDs', type: [String], required: false })
  @IsOptional()
  @IsArray()
  @IsMongoId({ each: true })
